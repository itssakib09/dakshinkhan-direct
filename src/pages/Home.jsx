...
function Home() {
  ...
  useEffect(() => {
    if (userProfile) {
      setIsBusinessUser(['business', 'service', 'admin'].includes(userProfile.role))
    }
  }, [userProfile])
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-20 lg:pb-8">
      <div className="w-full max-w-7xl mx-auto px-3 sm:px-4 md:px-6">
        ...
        >
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-4 sm:p-6 space-y-4 sm:space-y-5 border border-gray-100 dark:border-gray-700">
            ...
            <button className="w-full bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white rounded-xl py-4 sm:py-5 px-4 flex items-center justify-between shadow-lg">
              ...
              <HiArrowRight className="text-white" size={20} />
            </button>
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <Link to="/categories" className="text-xs sm:text-sm text-primary-600 dark:text-primary-400 font-bold flex items-center gap-1">
              See All
              <HiArrowRight size={14} />
            </Link>
          </div>
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <button className="text-xs sm:text-sm text-primary-600 dark:text-primary-400 font-bold flex items-center gap-1">
              View All
              <HiArrowRight size={14} />
            </button>
          </div>
      ...
      {/* Bottom Navigation */}
      <nav className="fixed bottom-0 left-0 right-0 bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl border-t border-gray-200 dark:border-gray-800 shadow-2xl z-50 lg:hidden">
        <div className="flex items-center justify-around py-2 px-2">
          {isBusinessUser ? (
            <>
              ...
              <Link to="/dashboard" className="flex flex-col items-center space-y-1 text-gray-400 dark:text-gray-500">
                <div className="w-11 h-11 bg-gray-100 dark:bg-gray-800 rounded-xl flex items-center justify-center">
                  <HiViewGrid size={20} />
                </div>
                <span className="text-xs">Dashboard</span>
              </Link>
              <Link to="/categories" className="flex flex-col items-center space-y-1 text-gray-400 dark:text-gray-500">
                <div className="w-11 h-11 bg-gray-100 dark:bg-gray-800 rounded-xl flex items-center justify-center">
                  <HiShoppingBag size={20} />
                </div>
                <span className="text-xs">Categories</span>
              </Link>
              <Link to="/login" className="flex flex-col items-center space-y-1 text-gray-400 dark:text-gray-500">
                <div className="w-11 h-11 bg-gray-100 dark:bg-gray-800 rounded-xl flex items-center justify-center">
                  <HiUser size={20} />
                </div>
            ...
            <>
              ...
              <Link to="/store" className="flex flex-col items-center space-y-1 text-gray-400 dark:text-gray-500">
                <div className="w-11 h-11 bg-gray-100 dark:bg-gray-800 rounded-xl flex items-center justify-center">
                  <HiShoppingBag size={20} />
                </div>
